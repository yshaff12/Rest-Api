...
echo _gettext("Go");
    ...
    {
        return new Source("", "table/insert/get_head_and_foot_of_insert_row_table.twig", "/storage/emulated/0/htdocs/phpmyadmin/templates/table/insert/get_head_and_foot_of_insert_row_table.twig");
    }
}
